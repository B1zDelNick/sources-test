    ...
    addPlayBtn(callback?: Function, x: number = -1, y: number = -1): Phaser.Button {
        ...
        this.playButton =
            GuiUtils.makeButton(
                ...
                [frame, frame, frame],
                true, false, true, callback, GuiUtils.addCustomOverHandler(0xffffff, 1.35), GuiUtils.addCustomOutHandler(1.3));
    ...
    addMoreBtn(): Phaser.Button {
        this.moreButton =
            GuiUtils.makeButton(
                ...
                GuiUtils.addCustomOverHandler(0xffffff, 1.35), GuiUtils.addCustomOutHandler(1.3));
